...
<div class="container my-lg-5" id="container-detail-artikel">
    <section class="position-relative">
        <div class="container-lg p-lg-5">
            <div class="row" style="box-shadow: 0 0 20px rgba(0, 0, 0, .08);border-radius:15px 15px 0 0 !important">
                <div class="image-artikel w-100 p-0 d-flex">
                ...
                <header id="header" class="site-header px-0" style="width: 100%; border-radius: 0 0 15px 15px !important">
                    <nav id="header-nav" class="navbar navbar-expand-lg" style="background: linear-gradient(to right, #6f6f5f, #e6e6de); padding-bottom: 15px; padding-top: 15px;border-radius:unset">
                        <div class="container">
                ...
                <footer id="footer-detail-artikel" class="padding-small pb-0">
                    <div class="container">
                        <div class="row">
